...
const forms: {
  ...
  teacher: (type, data) => <Suspense fallback={<Loading />}><TeacherForm type={type} data={data} /></Suspense>,
  student: (type, data) => <Suspense fallback={<Loading />}> <StudentForm type={type} data={data} /></Suspense>
};
